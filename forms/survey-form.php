 ...
 */ 
wp_register_script( 'survey-script', plugins_url() . '/mfs-survey/scripts/survey-script.js', 'jquery' );
...
if ( isset( $_COOKIE['survey_available'] ) ) {
	...
	<div id="dv_survey_error_message" class="error highlight">
		<p>
			<?php _e('Survey name already exits. Please provide other name.', 'mfs-survey'); ?>
		</p>
	</div>	
	<?php
...
<div class="wrap">
	<h2><?php _e('Add Survey', 'mfs-survey'); ?></h2>

	<!-- This form saves survey name -->
	<form action="edit.php?page=mfs-survey/survey-action.php&amp;noheader=true" method="post" name="form_add_survey" id="form_add_survey" onsubmit="return validate_add_survey();" autocomplete="off">	
		...
		<p class="submit">
			<input type="submit" name="btn_submit_survey" id="btn_submit_survey" value="<?php _e('Save', 'mfs-survey'); ?>" class="button" />
		</p>

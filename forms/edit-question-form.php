 ...
 */
wp_register_script( 'edit-question-script', plugins_url() . '/mfs-survey/scripts/edit-question-script.js', 'jquery' );
...
<div class="wrap">
	<h2><?php _e('Edit Question', 'mfs-survey'); ?></h2>
	
	<form action="edit.php?page=mfs-survey/survey-action.php&amp;noheader=true" method="post" name="form_edit_question" id="form_edit_question" onsubmit="return validate_add_question();" autocomplete="off">
		...
		<table class="widefat page" cellspacing="0" id="tbl_question">
			<thead>
				<tr>
					<th colspan="2">
						<?php _e('Edit Question and Options', 'mfs-survey'); ?>
					</th>
				</tr>
			</thead>
			<tbody>
		...
		<p class="submit">
			<input type="submit" name="btn_edit_question" id="btn_edit_question" value="<?php _e('Save', 'mfs-survey'); ?>" class="button" onclick="diplay_options();" />
		</p>

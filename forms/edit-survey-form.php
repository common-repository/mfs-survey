...
<div class="wrap">
	<h2><?php _e('Edit Survey', 'mfs-survey'); ?></h2>
	
	<!-- This form saves survey name -->
	<form action="edit.php?page=mfs-survey/survey-action.php&amp;noheader=true" method="post" name="form_edit_survey" id="form_edit_survey" onsubmit="return validate_edit_survey();" autocomplete="off">
		<table class="widefat page fixed" cellspacing="0">
			<thead>
				<tr>
					...
					<th>
						<?php _e('Select Start Page', 'mfs-survey'); ?>
					</th>
					<th>
						<?php _e('Select End Page', 'mfs-survey'); ?>
					</th>
				</tr>
			</thead>
			<tbody>
		...
		<table class="widefat page fixed" id="tbl_edit_survey" cellspacing="0">
			...
			<thead>
				<tr>
					<th><?php _e('Page Name', 'mfs-survey'); ?></th>
					<th><?php _e('Active', 'mfs-survey'); ?></th>
					<th><?php _e('Next Page', 'mfs-survey'); ?></th>
					<th width="5%"></th>
					<th width="5%"></th>
				</tr>
			</thead>
						...
						if ($question_data != NULL) {
							...
							echo "
								<td style='text-align:right;'>
									<a href='admin.php?page=forms/edit-page-form.php&survey_id=".$survey_id."&page_id=".$page_id."'>".__('Edit', 'mfs-survey')."</a>
								</td>";
								
						} else {
						
							echo '<td>'.__('Add question for this page', 'mfs-survey').'</td><td></td>';
		...
		<p class="submit">
			<input type="submit" name="btn_edit_survey" id="btn_edit_survey" value="<?php _e('Save', 'mfs-survey'); ?>" class="button" />
		</p>

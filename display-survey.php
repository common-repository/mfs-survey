...
function get_question_details( $page_id, $result_id ) {
	...
	$options .= '<form action="" method="post" name="form_diplay_page" id="form_diplay_page" autocomplete="off">';
	...
	foreach( $results as $result ) {
		...
		if ( $question_type === 'Button') {			
			...
			$options .= 
			'<p class="submit">
				<input type="submit" name="btn_save_answers" id="btn_save_answers" value="'. __('Save', 'mfs-survey') .'" class="button" />
			</p>';

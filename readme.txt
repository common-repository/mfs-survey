...
1. Add survey (You need to provide a name for a particular survey)

2. Add page (You can add as many pages for a particular survey)

3. Add question (Each of the above pages will have 1 question)

4. Manage surveys

5. Surveys' results

6. Specific survey report

7. User-specific survey results

8. Surveys list shown to user

9. Survey questions & answers shown to user
